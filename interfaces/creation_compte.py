...
bullet = "\u2022"
champMdp = customtkinter.CTkEntry(frameForm, width=350, height=30,show=bullet)
champMdp.place(x=180,y=200)
formConf = customtkinter.CTkLabel(frameForm,text="Confirmez mot de passe :")
formConf.place(x=20, y=280)
champConf = customtkinter.CTkEntry(frameForm, width=350, height=30, show=bullet)
champConf.place(x=280,y=280)
#boutonsuivant
suiv = customtkinter.CTkButton(app, text="Suivant", text_color="white", width=200, height=40,fg_color="#6c757d", state="disabled")
...
etats(barreCompte,etapeCompte,barreConf,etapeConf,barreFin,etapeFin)
app.mainloop()
